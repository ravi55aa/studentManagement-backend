...
export class ForgotPasswordService implements IForgotPasswordService{
    ...
    async verifyOtp(req:Request):Promise<serviceReturnType>{
        ...
        const data=await this.findValidOtp(id!,generatedOtp) 
        && generatedOtp===userEnteredOtp;
    ...
    async updatePassword(req:Request):Promise<serviceReturnType>{
        ...
        if(modelName=="admin"){
            ...
            message:adminPassUpdated ?"Password updated successfully":"Password isn't updated successfully"
            };
        } else if(modelName==="school"){
            ...
            message:schoolPassUpdated ?"Password updated successfully":"Password isn't updated successfully"
            }
        }  
