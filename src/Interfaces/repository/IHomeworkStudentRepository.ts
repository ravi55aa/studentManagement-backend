...
export interface IStudentHomeworkRepository {
    ...
    getStudentSubmissions(query: FilterQuery<Partial<IHomeworkSubmission>>): Promise<IHomeworkSubmission[]>;

    updateSubmission(id: string, data: Partial<IHomeworkSubmission>): Promise<IHomeworkSubmission | null>;
