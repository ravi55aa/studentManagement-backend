...
import { homeworkSubmissionModel, IHomeworkSubmission } from '@Models/Student/homeworkSubmitModel';
  ...
  implements IStudentHomeworkRepository
{
  ...
  // Submit homework
  async submitHomework(data: Partial<IHomeworkSubmission>): Promise<IHomeworkSubmission | null> {
    try {
