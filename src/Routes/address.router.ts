...
router.get('/get/:userId', authMiddleware, (req, res, next) =>
...
router.put('/edit/:userId', authMiddleware, (req, res, next) =>
  addressController.updateAddress(req, res, next),
);

router.patch('/edit/:userId', authMiddleware, (req, res, next) =>
  addressController.updateAddress(req, res, next),
);
