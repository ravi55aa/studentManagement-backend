...
import { StudentMessage,ServerMessage, BatchMessage, CommonMessage } from "@Constants/resposeMessages"; 
...
export class StudentService implements IStudentService {
    ...
    async getStudentsByQuery(
        query: FilterQuery<Partial<IStudent>>
    ...
    async deleteStudent(id: string): Promise<serviceReturnType> {
        ...
        const deleted = await this._studentRepository.updateStudent(
            id,
            { isDeleted: true }
        );
