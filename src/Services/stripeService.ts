...
import { CommonMessage, ServerMessage, StripeMessage, StudentMessage } from "@Constants/resposeMessages";
...
export class StripeService implements IStripeService {
    ...
    async createPaymentIntent(amount: number, studentFeeId: string,studentId: string): Promise<string|null> {
