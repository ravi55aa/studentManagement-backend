...
AcademicSubjectsSchema.index({ schoolId: 1, academicYear: 1, code: 1 }, { unique: true });

const academicSubjectsModel = mongoose.model<IAcademicSubject>(
  'AcademicSubjects',
  AcademicSubjectsSchema,
);
