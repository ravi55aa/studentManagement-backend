...
export class SchoolYear implements ISchoolAcademicYear{
    ...
    async getAAcademicYear(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule<Partial<IAcademicYear|null>>(
                    doc,
                        "Cant get academicYear",
                            "AcademicYear fetched successfully",
                                "Year not found",StatusCodes.CREATED);
    ...
    async deleteAcademicYear(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule(
                    doc,
                        "Cant get academicYear",
                            "AcademicYear fetched successfully",
                                "Year not found",StatusCodes.CREATED);
...
export class SchoolAcademicSubjectSer implements ISchoolAcademicSubjectSer{
    ...
    async addAcademicSubject(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule<IAcademicSubject>(newDoc,
                "Cant add new Subject",
                    "Added new Subject successfully",
                        "Cant add New Subject",201);
    ...
    async getAnAcademicSubject(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule<Partial<IAcademicSubject|null>>(doc,
                "Cant get academic subject",
                    "Subject Fetched successfully",
                        "Subject not found",200);
    ...
    async deleteAnAcademicSubject(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule(doc,
                "Cant Delete subject",
...
export class SchoolAcademicCoursesService implements ISchoolAcademicCourseSer {
        ...
        */
        ...
        if(newCourseDoc){
            await this.courseRepo.addNewCourse("AcademicCourseMeta",
                {...courseMetaDto,courseId:newCourseDoc?._id}
            );
        }
        ...
        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule<IAcademicCourse|null|IAcademicCourseMeta>(newCourseDoc,"error","messageTrue","messageFalse",200);
    ...
    async listAllAcademicCourses(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        const docCourses=await this.courseRepo.getAllCourses<IAcademicCourse>("AcademicCourse",query);
        const docCourses_meta=await this.courseRepo.getAllCourses<IAcademicCourseMeta>("AcademicCourseMeta",query);
    ...
    async getAnAcademicCourse(req:Request,res:Response):Promise<serviceReturnType> {
        ...
        const docOfCourse:IAcademicCourse|null=await this.courseRepo.findOneFromCourse({_id:id,tenantId:tenantId,adminId:adminId});

        const docOfCourse_meta:IAcademicCourseMeta|null=await this.courseRepo.findOneFromCourseMeta({courseId:id});
    ...
    async updateAcademicCourse(req:Request,res:Response):Promise<serviceReturnType>{
        ...
        */
        ...
        if(courseDto.academicYear && docOfAcademicYear ) {courseDto.academicYear = docOfAcademicYear._id };
        ...
        */
        ...
        await this.courseRepo.updateCourse("AcademicCourseMeta",{courseId:id},{...courseMetaDto},);

        const { status,resBody } = 
            AcademicYearResponseBody.newAcademicModule<IAcademicCourse|null|IAcademicCourseMeta>(docUpdatedCourse,"error","messageTrue","messageFalse",200);
    ...
    async deleteAnAcademicCourse(req:Request,res:Response):Promise<serviceReturnType>
    {
        ...
        */
        const docCourse:IAcademicCourse|null=await this.courseRepo.deleteCourse<IAcademicCourse>("AcademicCourse",{_id:id,...query});
        await this.courseRepo.deleteCourse<IAcademicCourseMeta>("AcademicCourseMeta",{courseId:id,...query});
        
        const {status,resBody}=AcademicYearResponseBody.handleDeleteOneResBody<IAcademicCourse>(docCourse);
