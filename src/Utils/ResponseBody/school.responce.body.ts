...
//**SUBJECTS */
    static newDocument<T>(doc:T|null,error:string,message:string,errMessage:string,statusCode:number){
    ...
    static forUpdate<T>(doc:T|null,theError:string,theMessage:string,theMessageErr:string,statusCode:number){
