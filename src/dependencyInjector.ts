...
export const documentController =
    container.resolve(DocumentController);
...
export const schoolController =
    container.resolve(SchoolController);

export const centerController =
    container.resolve(CentersController);

export const batchController =
    container.resolve(BatchController);
...
*/
export const schoolAcademicController =
    container.resolve(SchoolAcademicController)

/**
 * school Academic Subject
*/
export const schoolAcaSubController=
    container.resolve( SchoolAcademicSubjectController);

/**
 * school Academic Course
*/
export const schoolAcaCourseController=
    container.resolve(SchoolAcademicCourseController);

/**
 * TEACHER
 */
export const teacherController=
    container.resolve(TeacherController);
...
export const feeController=
    container.resolve(FeeController);